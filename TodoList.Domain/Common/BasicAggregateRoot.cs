...
{
    private readonly ICollection<DomainEventRecord> _distributedEvents = new List<DomainEventRecord>();
    private readonly ICollection<DomainEventRecord> _localEvents = new List<DomainEventRecord>();
